...
namespace CPU
{
	...
	enum CPUIDFeatureSet6
	{ // EAX=7, ECX=1, EAX set
		CPUID_AVX512_BF16 = 1 << 5,
	};

	enum CPUIDFeatureSetAMD1
	{ // EAX=0x80000001, EDX set
		CPUID_MP = 1 << 19,
		CPUID_NX = 1 << 20,
		CPUID_MMXEXT = 1 << 22,
		CPUID_FXSR_OPT = 1 << 25,
	...
	enum CPUIDFeatureSetAMD2
	{ // EAX=0x80000001, ECX set
		CPUID_LAHF_LM = 1 << 0,
